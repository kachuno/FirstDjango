...
def signup(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            form.save()
            return redirect('YukaSite:index')
    else:
        form = SignUpForm()

    context = {'form':form}
    return render(request, 'YukaSite/signup.html', context)
...
def post_create(request):
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            post.save()
            return redirect('YukaSite:post_all')
    else:
        form = PostForm()

    context = {'form':form}
    return render(request, 'YukaSite/post_create.html', context)
...
def recipe_upload(request):
    if request.method == 'POST':
        ...
        form = RecipeForm()
    return render(request, 'YukaSite/recipe_upload.html', {
        'form': form
    })
...
def schedule_create(request):
    ...
    context = {'form':form}
    return render(request, 'YukaSite/schedule_create.html', context)
...
def schedule_edit(request, schedule_id):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            params = {'message': '教室スケジュール', 'data': data}
            return render(request, 'YukaSite/schedule_all.html',params)
    else:
        form = ScheduleForm(instance=obj)

    context = {'form':form, 'id':schedule_id}
    return render(request, 'YukaSite/schedule_edit.html', context)
...
def schedule_delete(request, schedule_id):
    ...
    return render(request, 'YukaSite/schedule_delete.html', context)
...
def schedule_select(request):
    ...
    context = {'form':form}
    return render(request, 'YukaSite/schedule_select.html', context)
...
def lesson_detail(request, lesson_id):
    ...
    return render(request, 'YukaSite/lesson_detail.html', params)
...
def lesson_create(request):
    if request.method == "POST":
        ...
        form = LessonForm()
    context = {'form':form}
    return render(request, 'YukaSite/lesson_create.html', context)
...
def lesson_edit(request, lesson_id):
    ...
    return render(request, 'YukaSite/lesson_edit.html', context)
...
def lesson_delete(request, lesson_id):
    ...
    return render(request, 'YukaSite/lesson_delete.html', context)
...
def news_create(request):
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            params = {'data': data}
            return render(request, 'YukaSite/news_all_admin.html', params)
    else:
        form = NewsForm()

    context = {'form':form}
    return render(request, 'YukaSite/news_create.html', context)
...
def news_all(request):
    data = News.objects.all().order_by('created_at').reverse()
    params = {'data': data}
    return render(request, 'YukaSite/news_all.html', params)
...
def news_edit(request, news_id):
    ...
    return render(request, 'YukaSite/news_edit.html', context)
...
def news_delete(request, news_id):
    ...
    return render(request, 'YukaSite/news_delete.html', context)

##お知らせ詳細
@login_required
def news_detail(request, news_id):
    news = News.objects.get(id=news_id)
    return render(request, 'YukaSite/news_detail.html', {'news': news })

##レシピ一覧（管理者用）
def recipe_all_admin(request):
    data = Recipe.objects.all().order_by('holdmonth').reverse()
    params = {'data': data}
    return render(request, 'YukaSite/recipe_all_admin.html', params)
...
def recipe_edit(request, recipe_id):
    ...
    return render(request, 'YukaSite/recipe_edit.html', context)
...
def recipe_delete(request, recipe_id):
    ...
    return render(request, 'YukaSite/recipe_delete.html', context)

##ユーザー　一覧
def user_all(request):
    data = User.objects.all()
    params = {'data': data}
    return render(request, 'YukaSite/user_all.html', params)
...
def user_detail(request, user_id):
    ...
    return render(request, 'YukaSite/user_detail.html', params)
