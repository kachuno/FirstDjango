...
urlpatterns = [
    ...
    path('login/',
          auth_views.LoginView.as_view(template_name="YukaSite/login.html"), name='login'),
    path('logout/', auth_views.LogoutView.as_view(next_page="YukaSite:login"), name='logout'),
